...
**Not next:** ViT-style code built on `einops.rearrange` needs its pattern strings stubbed, and a diffusion
U-Net's skip connections push and pop tensors of different shapes in loops.
